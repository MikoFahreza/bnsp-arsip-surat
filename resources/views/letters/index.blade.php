...
<div class="row">
    <div class="col-md-3 bg-light" style="min-height: 100vh;">
        ...
        <ul class="nav flex-column mb-4">
            <li class="nav-item mb-2"><a class="nav-link active" href="{{ route('letters.index') }}">Arsip</a></li>
            <li class="nav-item mb-2"><a class="nav-link" href="{{ route('categories.index') }}">Kategori Surat</a></li>
