...
<div class="row">
    <div class="col-md-2 bg-light" style="min-height: 100vh; border-radius: 12px 0 0 12px;">
        ...
        <ul class="nav flex-column mb-4">
            ...
            <li class="nav-item mb-2"><a class="nav-link active rounded-pill px-3 py-2" style="background:#e9ecef;font-weight:500;" href="{{ route('categories.index') }}">Kategori Surat</a></li>
                ...
                @forelse ($categories as $category)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 text-sm text-gray-600">
                            ...
                            <a href="{{ route('categories.edit', $category->id) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-xs ml-1 transition">Edit</a>
                        </td>
                    </tr>
                @empty
                    <tr>
